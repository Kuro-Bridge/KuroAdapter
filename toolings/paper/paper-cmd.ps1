...
# 用法：toolings\paper\paper.cmd cmd kurobridge qr
#   或  powershell -NoProfile -File toolings\paper\paper-cmd.ps1 kurobridge qr
...
if (-not (Test-Path $cmdIn)) { throw "缺少 $cmdIn（服务器未启动？先运行 toolings\paper\paper.cmd start）" }
