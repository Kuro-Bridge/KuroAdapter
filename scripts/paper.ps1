...
# 四个壳合一，样板只写一次）。
# 用法（仓库任意位置）：scripts\paper.cmd <子命令> [参数...]
...
$usage = @"
用法：scripts\paper.cmd <start|stop|cmd|qr> [参数...]
