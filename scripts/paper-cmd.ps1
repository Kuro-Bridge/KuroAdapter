...
# 用法：scripts\paper.cmd cmd kurobridge qr
#   或  powershell -NoProfile -File scripts\paper-cmd.ps1 kurobridge qr
...
if (-not (Test-Path $cmdIn)) { throw "缺少 $cmdIn（服务器未启动？先运行 scripts\paper.cmd start）" }
